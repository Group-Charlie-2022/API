...
class Medical(Routine):
    ...
    def process(inp, history):
        response = openai.Answer.create(
            ...
            examples=[["What has the most risk from getting COVID?",
                      ...
                      ["YOOOO CAN I SPREAD EPILEPSY TO OTHERS??????",
                      ...
                      ['HEEEEY CAN I DO SOMETHING TO AVOID GETTING A BURULI ULCER? PLEASEEE',
